...
<head>
    ...
    <title>Pharmacy Seller Login - PharmaPortal</title>
...
<div class="w-full max-w-md p-4 box-border">
    <div class="bg-white px-8 py-10 rounded-2xl shadow-xl shadow-emerald-950/5 border border-emerald-500/10 text-center">
        ...
        <div class="w-16 h-16 bg-blue-600 text-white rounded-2xl flex items-center justify-center text-3xl font-bold mx-auto mb-5 shadow-lg shadow-blue-600/20">
            💚
        </div>
        
        <h1 class="text-2xl font-bold text-slate-800 tracking-tight mb-1">Pharmacy Seller</h1>
        <p class="text-sm text-slate-500 mb-8">Point-of-sale access</p>
